...
async function calcSell(tokensToSell, tokenAddres) {
  const web3 = new Web3("https://bsc-dataseed1.binance.org");
  const BNBTokenAddress = "0xe9e7cea3dedca5984780bafc599bd69add087d56"; //BNB
...
*/
(async () => {
  const tokenAddres = "0xab6FCDFA84DE99d4fFBE4b200749bd27197517Ba"; // change this with the token addres that you want to know the
  ...
  console.log(
    "PLAS Token VALUE IN BNB : " + priceInBnb + " | Just convert it to USD "
  );
  console.log(`PLAS Token VALUE IN USD: ${priceInBnb * bnbPrice}`); // convert the token price from BNB to USD based on the retrived BNB value
})();
